    ...
    <div class="footer_size">
        ...
        <div class="footer_4">
            ...
            <div class="footer_soc">
                <img src="{{asset('assets/site/main/img/facebook.png')}}" alt="">
                <img src="{{asset('assets/site/main/img/twitter.png')}}" alt="">
                <img src="{{asset('assets/site/main/img/instagram.png')}}" alt="">
            </div>
        </div>
    </div>
