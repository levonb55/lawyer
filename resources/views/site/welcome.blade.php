...
@section('content')
        ...
        <div class="lawyers_4_size">
            <div class="lawyers_4_left">
                <div class="lawyers_items" id="lawyers_items1" data-id="image1">
                    <div class="verified">
                        <img src="{{asset('assets/site/main/img/verified.png')}}" alt="">
            ...
            <div class="lawyers_4_right active">
                ...
                <div class="lawyers_4_right_box" id="image3">
                    ...
                    <div class="book">
                        <img src="{{asset('assets/site/main/img/Book.png')}}" alt="">
                    </div>
    ...
    <section  class="lawyers_4">
        <div class="lawyers_4_size">
            <div class="lawyers_4_right1 ">
                <div class="lawyers_4_right_box1" id="image4">
                    <img src="{{asset('assets/site/main/img/Polygon.png')}}" alt="">
                </div>
                <div class="lawyers_4_right_box1" id="image5">
                    <img src="{{asset('assets/site/main/img/search.png')}}" alt="">
                </div>
                <div class="lawyers_4_right_box1" id="image6">
                    <img src="{{asset('assets/site/main/img/share.png')}}" alt="">
                </div>
            </div>
            <div class="lawyers_4_left">
        ...
        <div class="lawyers_4_left_bottom lawyers_4_left_bottom1">
            ...
            <a href="{{route('single')}}"><button type="button" name="button" class="Learn_more">Learn more</button></a>
        </div>
    </section>
                    ...
                    <div class="item">
                        ...
                        <div class="slider_box">
                            ...
                            <div class="slider_box_top">
                                <img src="{{asset('assets/site/main/img/slider2.png')}}" alt="">
                            </div>
                            ...
                            <div class="slider_box_bottom">
                                <img src="{{asset('assets/site/main/img/slider3.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="item">
