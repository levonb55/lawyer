...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="" class="btn btn-primary" data-toggle="modal" data-target="#mediumModal">Add Term</a>
            </div>
        </div>
        <br>
                                    ...
                                    <form id="works_update" method="post" action="{{route('update_home_content',$term->id)}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('delete_content',$term->id)}}" class="btn btn-danger">delete</a>
                                            </td>
                                        </tr>
                                    </form>
                                @endforeach
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Add term</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{route('add_term')}}" method="post" id="save_term" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <div class="row form-group">
